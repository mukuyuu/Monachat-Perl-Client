...
### Can't continue when there is a blank file
...
push(@filelist, "tripbackup.txt") if -e "tripbackup.txt";
...
foreach my $file (@filelist)
    ...
    foreach my $entry (@file)
        ...
        ### Print progress
        $line++;
        print "total:$totallines | file: $actualfile/$totalfiles @ $line\n";
