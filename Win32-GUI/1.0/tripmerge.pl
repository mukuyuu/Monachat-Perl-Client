...
print <<"WARNINGEND";
+-------------------------------------------------------------------------------------------------------------------+
| IMPORTANT: MAKE A BACKUP BEFORE ATEMPTING TO MERGE TRIP FILES, PRESS ENTER TO CONTINUE                          |
+-------------------------------------------------------------------------------------------------------------------+
WARNINGEND
...
if( !@ARGV and -e "tripbackup" )
  ...
  ### Filter backup files and format them
  @filestodelete = grep(!/backup/, @filestodelete);
