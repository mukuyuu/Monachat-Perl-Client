...
* 最近IDが１０００を超えてきて、V1.2以下だとユーザーが表示されなかったり、エラーが出たりするかもしれないから絶対に１．２を使ってください。
...
```
cpan
install Encode Win32::GUI IO::Socket::Socks LWP::UserAgent Win32::Clipboard WWW::Shorten JSON JSON::Parse
```
